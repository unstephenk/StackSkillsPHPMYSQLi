...
<form method="post" action="mysqli_edit_data.php">
...
<table width="500" bgcolor="orange" border="2">
    ...
    while($row=mysqli_fetch_array($run) ){
        ...
        <tr align="center">
            ...
            <td><a href="mysqli_edit_data.php?edit=<?php echo $user_id; ?>">Edit</a></td>
            <td><a href="mysqli_edit_data.php?delete=<?php echo $user_id; ?>">Delete</a></td>
        </tr>
    <?php  }    ?>
...
if(isset($_GET['delete'])){
    ...
    if ($run_delete){
        ...
        echo "<script>window.open('mysqli_edit_data.php','_self')</script>";
    }
}

if(isset($_GET['edit'])){
    include("mysqli_edit_data_form.php");
}
?>
